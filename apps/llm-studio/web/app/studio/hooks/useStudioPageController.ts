...
export function useStudioPageController(): StudioPageViewProps {
  ...
  const editor = useStudioDocumentEditor({
    ...
    componentPrefabs: workspace.componentPrefabs,
  ...
  return {
    ...
    canUndoDocument: workspace.canUndoDocument,
    canRedoDocument: workspace.canRedoDocument,
    undoDocument: workspace.undoDocument,
    redoDocument: workspace.redoDocument,
    ...
    saveComponentAsPrefab: workspace.saveComponentAsPrefab,
    updateComponentPrefab: workspace.updateComponentPrefab,
    deleteComponentPrefab: workspace.deleteComponentPrefab,
    insertComponentAt: editor.insertComponentAt,
    insertComponentFromPrefab: editor.insertComponentFromPrefab,
    replaceAllComponentsWithPrefab: editor.replaceAllComponentsWithPrefab,
    replaceAllComponentsWithComponentSettings: editor.replaceAllComponentsWithComponentSettings,
